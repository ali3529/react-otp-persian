...
var SingleOtpInput = function (_PureComponent) {
    ...
    _createClass(SingleOtpInput, [{
        ...
        key: "render", value: function render() {
            var _this$props3 = this.props, placeholder = _this$props3.placeholder, separator = _this$props3.separator, isLastChild = _this$props3.isLastChild, inputStyle = _this$props3.inputStyle, focus = _this$props3.focus, isDisabled = _this$props3.isDisabled, hasErrored = _this$props3.hasErrored,
                errorStyle = _this$props3.errorStyle, focusStyle = _this$props3.focusStyle, disabledStyle = _this$props3.disabledStyle, shouldAutoFocus = _this$props3.shouldAutoFocus, isInputNum = _this$props3.isInputNum, index = _this$props3.index, value = _this$props3.value,
                className = _this$props3.className, isInputSecure = _this$props3.isInputSecure, rest = _objectWithoutProperties(_this$props3, _excluded);
            return _react["default"].createElement("div", {
                className: className,
                style: {display: 'flex', alignItems: 'center'}
            }, _react["default"].createElement("input", _extends({
                "aria-label": "".concat(index === 0 ? 'Please enter verification code. ' : '').concat(isInputNum ? 'Digit' : 'Character', " ").concat(index + 1),
                autoComplete: "off",
...
var OtpInput = function (_Component) {
    ...
    function OtpInput() {
        ...
        _defineProperty(_assertThisInitialized(_this2), "focusInput", function (input) {
            ...
            _this2.setState({activeInput: activeInput});
        });
        ...
        _defineProperty(_assertThisInitialized(_this2), "handleOnPaste", function (e) {
            ...
            var pastedData = e.clipboardData.getData('text/plain').toEnglishDigits().slice(0, numInputs - activeInput).split('');
        ...
        _defineProperty(_assertThisInitialized(_this2), "handleOnChange", function (e) {
            ...
            var enValue = value.toEnglishDigits();
            if (_this2.isInputValueValid(enValue)) {
                _this2.changeCodeAtFocus(enValue);
            }
        });
        ...
        _defineProperty(_assertThisInitialized(_this2), "handleOnInput", function (e) {
            var enValue = e.target.value.toEnglishDigits();
            if (_this2.isInputValueValid(enValue)) {
                _this2.focusNextInput();
            } else {
        ...
        _defineProperty(_assertThisInitialized(_this2), "renderInputs", function () {
            var activeInput = _this2.state.activeInput;
            var _this2$props3 = _this2.props, numInputs = _this2$props3.numInputs, inputStyle = _this2$props3.inputStyle, focusStyle = _this2$props3.focusStyle, separator = _this2$props3.separator, isDisabled = _this2$props3.isDisabled, disabledStyle = _this2$props3.disabledStyle,
                hasErrored = _this2$props3.hasErrored, errorStyle = _this2$props3.errorStyle, shouldAutoFocus = _this2$props3.shouldAutoFocus, isInputNum = _this2$props3.isInputNum, isInputSecure = _this2$props3.isInputSecure, className = _this2$props3.className;
            var inputs = [];
            var otp = _this2.getOtpValue();
...
_defineProperty(OtpInput, "defaultProps", {
    numInputs: 4, onChange: function onChange(otp) {
